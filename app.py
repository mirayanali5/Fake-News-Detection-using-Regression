...
#         st.error("Please ensure model.pkl and vectorizer.pkl files are in the same directory as the script.")
#         return None, None
...
#         st.error("Dataset file not found. Please ensure 'train.csv' is in the correct directory.")
#         return None

# # Enhanced prediction function with confidence score
# def predict_news(text, model, vectorizer):
#     if model is None or vectorizer is None:
#         st.error("Model or vectorizer not loaded. Please train the model first.")
#         return None, None
...
# # Enhanced dataset statistics and visualization with error handling
...
#     real_news = int(len(df[df['label'] == 0]))  # Convert to int
#     fake_news = int(len(df[df['label'] == 1]))  # Convert to int
    
#     # Display metrics in columns with emojis
...
#     ax1.bar(['Real News', 'Fake News'], 
#             [real_news, fake_news],
#             color=colors)
#     ax1.set_ylabel('Number of Articles')
#     ax1.set_title('Distribution (Count)')
    
#     # Pie chart - only create if we have valid data
#     if real_news + fake_news > 0:  # Check if we have valid data
#         sizes = [real_news, fake_news]
#         labels = ['Real News', 'Fake News']
#         ax2.pie(sizes, labels=labels, colors=colors, autopct='%1.1f%%', startangle=90)
#         ax2.set_title('Distribution (Percentage)')
#     else:
#         ax2.text(0.5, 0.5, 'No valid data available', 
...
#         if total_articles > 0:  # Only calculate percentages if we have data
...
#         else:
#             st.write("No valid data available for distribution")
    
#     with col2:
#         st.write("Key Metrics:")
#         # Safely calculate text statistics
...
#         else:
#             st.write("No valid text data available for analysis")
...
#                         # Create columns for result and confidence
#                         col1, col2 = st.columns(2)
...
#     # Tab 2: Enhanced Dataset Preview
#     with tab2:
#         df = load_dataset()
#         if df is not None:
#             # Show enhanced dataset statistics and visualization
